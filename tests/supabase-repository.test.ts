...
describe('SupabaseRepository', () => {
  ...
  describe('exportAll / importAll', () => {
    ...
    it('importAll 每表先 delete().neq(id) 清空再 upsert，载荷 snake_case', async () => {
      ...
      expect(tasksUpsert?.payload).toEqual([{ id: 't1', title: '任务', focus: false, priority: 'low', status: 'todo', due_date: null, due_time: null, focus_date: null, tags: [], sort: 1, completed_at: null, created_at: '2026-08-01T00:00:00.000Z', repeat: null, checklist: null, note: null }])
