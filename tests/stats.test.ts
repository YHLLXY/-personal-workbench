...
describe('stats', () => {
  ...
  it('activeNoteCount 只计未归档笔记', () => {
    const notes: Note[] = [
      { id: 'a', content: 'x', tags: [], archived: false, pinned: false, createdAt: '2026-08-01T00:00:00.000Z', updatedAt: '2026-08-01T00:00:00.000Z' },
      { id: 'b', content: 'y', tags: [], archived: true, pinned: false, createdAt: '2026-08-01T00:00:00.000Z', updatedAt: '2026-08-01T00:00:00.000Z' },
    ]
