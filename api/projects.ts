...
export const FALLBACK_PROJECTS: ProjectInfo[] = [
  ...
  { name: '蔬菜定价优化', emoji: '🥬', phase: '已完成', stack: ['Python', '报童模型', 'MIP'], aliases: ['蔬菜定价', 'CUMCM-2023-C'], updatedAt: '2026-07-29', summary: '某生鲜商超 6 大蔬菜品类的自动定价与补货优化问题。目标是最大化 7 天总期望利润，同时满足陈列量、损耗率、品类覆盖等约束。' },
